  ...
  return (
    <BrowserRouter>
      <Switch>
        ...
        <Route exact path="/comidas/:id-da-receita/in-progress" component={ ComidasIDProgress } />
        <Route exact path="/bebidas/:id-da-receita/in-progress" component={ BebidasIDProgress } />
