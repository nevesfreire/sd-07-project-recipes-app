...
describe('Testar a barra de busca', () => {
  test('Possui 3 radio buttons: Ingrediente, Nome e Primeira letra', () => {
...
describe('Testar a API chamada pela barra de busca', () => {
  test('Busque na API de comidas caso a pessoa esteja na página de comidas', () => {
    const { getByTestId, history } = renderWithRouter(<App />);
  ...
  test('Busque na API de bebidas caso a pessoa esteja na página de bebidas', () => {
    const { getByTestId, history } = renderWithRouter(<App />);
    const WAITING_TIME = 500;
...
describe('Testar detalhes da receita', () => {
  test('Redirecione para detalhes da receita se apenas uma receita seja encontrada', () => {
    const { getByTestId, history } = renderWithRouter(<App />);
