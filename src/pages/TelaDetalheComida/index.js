...
class TelaDetalheComida extends Component {
  ...
  render() {
    const { ingredientsArray, measuresArray, meal } = this.state; // Props card will send this information
    return (
      <>
        <img data-testid="recipe-photo" alt="comida" src={ meal.strMealThumb } />
...
export default TelaDetalheComida;
